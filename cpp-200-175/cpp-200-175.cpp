// cpp-200-175.cpp : This file contains the 'main' function. Program execution begins and ends there.
//
...
int main()
{
	...
	auto result1 = std::minmax_element(data.begin(), data.end());
	...
	auto result2 = std::minmax_element(data.begin(), data.end(), [](int arg1, int arg2) { return arg1 < arg2; });
